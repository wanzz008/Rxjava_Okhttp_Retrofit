...
//        url = "http://lkyj-app.oss-cn-qingdao.aliyuncs.com/znyj.apk";
        url = "http://lkyj-app.oss-cn-qingdao.aliyuncs.com/zj.apk";
    ...
    public void download(View view) {
        ...
        if (isOk)
            // 调用方法
            for (int i = 0; i < 1; i++) {
                mDownloadHelper.downloadFile(url, Environment.getExternalStorageDirectory() + File.separator + "/apk/aa/bb", "a"+ i +".apk");
            }
    }
