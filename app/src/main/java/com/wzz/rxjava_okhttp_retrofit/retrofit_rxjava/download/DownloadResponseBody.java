...
public class DownloadResponseBody extends ResponseBody {
    ...
    DownloadResponseBody(ResponseBody responseBody, DownloadListener mDownloadListener) {
        ...
        this.mDownloadListener = mDownloadListener; // 下载监听
...
//                Log.e("downloadImg", "read.........responseBody.contentLength: " + responseBody.contentLength()  );
                long bytesRead = super.read(sink, byteCount);
                // read() returns the number of bytes read, or -1 if this source is exhausted.
                totalBytesRead += bytesRead != -1 ? bytesRead : 0;
//                Log.e("downloadImg", "read: "+ (int) (totalBytesRead * 100 / responseBody.contentLength()));
